package com.capgemini.laps.util;
...
public class DBConnection {
	 ...
	 ***************************************************************************************/
	private DBConnection() throws CustomerException {
		try {
	...
	public static DBConnection getInstance() throws CustomerException {
	 ...
	 *******************************************************************/
	public Connection getConnection() throws CustomerException {
		try {
			...
			throw new CustomerException(" Database connection problem");
		}
		return conn;
	}
